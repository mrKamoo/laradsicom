                    ...
                    <div class="card-body">
                        <form action="{{ route('communes.update', $commune) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('code_postal') is-invalid @enderror"
                                               id="code_postal" name="code_postal" value="{{ old('code_postal', $commune->code_postal) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('code_insee') is-invalid @enderror"
                                               id="code_insee" name="code_insee" value="{{ old('code_insee', $commune->code_insee) }}"
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="active"
                                                   name="active" {{ old('active', $commune->active) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('adresse') is-invalid @enderror"
                                                  ...
                                                  placeholder="Adresse complète de la mairie">{{ old('adresse', $commune->adresse) }}</textarea>
                                        @error('adresse')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" class="form-control @error('telephone') is-invalid @enderror"
                                               id="telephone" name="telephone" value="{{ old('telephone', $commune->telephone) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                               id="email" name="email" value="{{ old('email', $commune->email) }}"
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('communes.show', $commune) }}" class="btn btn-secondary">
